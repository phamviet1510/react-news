...
const renderPublishedAt = (article) => {
  return article.publishedAt && `at ${article.publishedAt.format('MMM D, YYYY')}`
}
  ...
  return <div className="col-12 col-sm-9 mb-5 mx-auto">
    <div className="card">
      <div className="card-body">
        <Link to={`blog/${article.slug}`} className="card-link"><h4 className="card-title">{article.title}</h4></Link>
