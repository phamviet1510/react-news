...
@endsection
@push('styles')
	{{--<link href="{{ asset('css/admin/vendors/custom/fullcalendar/fullcalendar.bundle.css') }}" rel="stylesheet" type="text/css" />--}}
@endpush
@push('scripts')
	{{--<script src="{{ asset('js/admin/vendors/custom/fullcalendar/fullcalendar.bundle.js') }}" type="text/javascript"></script>--}}
	<script src="{{ asset('js/admin/app/js/dashboard.js') }}" type="text/javascript"></script>
@endpush